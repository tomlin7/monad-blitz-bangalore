  ...
  return (
    <div className="flex flex-col gap-12 pb-12">
      <section className="text-center flex flex-col items-center mt-8 px-4">
        <div className="bg-neo-accent-pink neo-badge text-white mb-6 animate-pulse">Monad + Sarvam AI</div>
        ...
        <h2 className="font-pixel text-2xl sm:text-4xl md:text-5xl uppercase leading-relaxed mb-6 tracking-tight text-center drop-shadow-[2px_2px_0px_#000]">
          <span className="bg-white px-2 leading-loose">EVIDENCE DECIDES.</span><br className="md:hidden" />
          <span className="bg-neo-bg-red text-white px-4 inline-block transform -rotate-2 mt-6 text-xl sm:text-3xl p-2 drop-shadow-[4px_4px_0px_#000]">NO MORE VETO POWER</span><br />
          <span className="bg-neo-bg-blue text-white px-4 inline-block transform rotate-1 mt-4 text-xl sm:text-3xl p-2 drop-shadow-[4px_4px_0px_#000]">TO THE OWNER.</span>
        </h2>
